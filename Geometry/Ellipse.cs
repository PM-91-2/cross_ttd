...
namespace Geometry
{
    ...
    {
        private List<Vector2> _points_ellipse;
        private List<Vector2> _points;//координаты прямоугольника в который вписан эллипс
        ...
        public string PathData
        {
            ...
            get
            {
                ...
                return string.Format("M {0},{1} A {2},{3} {4} {5} {6} {7},{8} " +
                    ...
                    _points_ellipse[0].X, _points_ellipse[0].Y,
                    x_radius / (y_radius + x_radius), y_radius / (y_radius + x_radius),
                    _angle, 0, 0, _points_ellipse[2].X, _points_ellipse[2].Y,
                    x_radius / (y_radius + x_radius), y_radius / (y_radius + x_radius),
                    _angle, 0, 0, _points_ellipse[0].X, _points_ellipse[0].Y);
